...
class table_wirror_stock extends discuz_table
{
	public function __construct() {

		$this->_table = 'wirror_stock';
		$this->_pk    = '';
	...
	public function  fetch_by_uid($uid)
   {
	...
	public function update_by_uid01($uid,$money)
	{
		return DB::query("UPDATE  %t  SET  sumexp=".$money.",updatetime=".time()."  WHERE uid=%s", array($this->_table, $uid));
	}
}
