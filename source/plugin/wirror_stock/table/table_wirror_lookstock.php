...
class table_wirror_lookstock extends discuz_table
{
	public function __construct() {

		$this->_table = 'wirror_lookstock';
		$this->_pk    = '';
	...
	public function  fetch_by_uid($uid)
   {
	...
	{
		return DB::query("UPDATE  %t  SET  count=".$money."  WHERE uid=%s", array($this->_table, $uid));
	}
	...
	public function getUIDs(){
				...
				return DB::fetch_all('SELECT  distinct uid  FROM  %t ', array($this->_table));
